				...
				case "1" :
					do {
						...
						if(numero.equals("1")){
							...
							if(choix.equals("2")){
								moteurDeRecherche.setAffichageType(new AffichageAllSorted());
							}
							if(choix.equals("3")){
					...
					do{
						...
						switch(numero1) {
							case "1":
								...
								List<List<Stat2>> stat=moteurDeRecherche.getIndex().getStatrequette(moteurDeRecherche.traitementDeRequete(requete3));

								List<Stat3> score=moteurDeRecherche.getScore().calculer(stat);
								List<String> list123=moteurDeRecherche.getAffichageType().affiche1(score, moteurDeRecherche.traitementDeRequete(requete3));
								System.out.println("le resultat de recherche est:");
								//System.out.println(list123);
								for (String i:list123) {
									System.out.println(i);
								}
								//si vous voulez demander a l'utilisateur si il veut effectuer un filtre par mots eliminer le commentiare
